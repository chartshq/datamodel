...
module.exports = JSON.parse("{\"name\":\"datamodel\",\"description\":\"Relational algebra compliant in-memory tabular data store\",\"homepage\":\"https://github.com/chartshq/datamodel\",\"version\":\"2.2.1-alpha\",\"license\":\"MIT\",\"main\":\"dist/datamodel.js\",\"keywords\":[\"datamodel\",\"data\",\"relational\",\"algebra\",\"model\",\"muze\",\"fusioncharts\",\"table\",\"tabular\",\"operation\"],\"author\":\"Muzejs.org (https://muzejs.org/)\",\"repository\":{\"type\":\"git\",\"url\":\"https://github.com/chartshq/datamodel.git\"},\"contributors\":[{\"name\":\"Akash Goswami\",\"email\":\"akashgoswami90s@gmail.com\"},{\"name\":\"Subhash Haldar\"},{\"name\":\"Rousan Ali\",\"email\":\"rousanali786@gmail.com\",\"url\":\"https://rousan.io\"},{\"name\":\"Ujjal Kumar Dutta\",\"email\":\"duttaujjalkumar@live.com\"}],\"dependencies\":{\"d3-dsv\":\"^1.0.8\"},\"devDependencies\":{\"babel-cli\":\"6.26.0\",\"babel-core\":\"^6.26.3\",\"babel-eslint\":\"6.1.2\",\"babel-loader\":\"^7.1.4\",\"babel-plugin-transform-runtime\":\"^6.23.0\",\"babel-preset-env\":\"^1.7.0\",\"babel-preset-es2015\":\"^6.24.1\",\"babel-preset-flow\":\"^6.23.0\",\"chai\":\"3.5.0\",\"cross-env\":\"^5.0.5\",\"eslint\":\"3.19.0\",\"eslint-config-airbnb\":\"15.1.0\",\"eslint-plugin-import\":\"2.7.0\",\"eslint-plugin-jsx-a11y\":\"5.1.1\",\"eslint-plugin-react\":\"7.3.0\",\"istanbul-instrumenter-loader\":\"^3.0.0\",\"jsdoc\":\"3.5.5\",\"json2yaml\":\"^1.1.0\",\"karma\":\"1.7.1\",\"karma-chai\":\"0.1.0\",\"karma-chrome-launcher\":\"2.1.1\",\"karma-coverage-istanbul-reporter\":\"^1.3.0\",\"karma-mocha\":\"1.3.0\",\"karma-spec-reporter\":\"0.0.31\",\"karma-webpack\":\"2.0.3\",\"marked\":\"^0.5.0\",\"mocha\":\"3.4.2\",\"mocha-webpack\":\"0.7.0\",\"transform-runtime\":\"0.0.0\",\"webpack\":\"^4.12.0\",\"webpack-cli\":\"^3.0.7\",\"webpack-dev-server\":\"^3.1.4\"},\"scripts\":{\"test\":\"npm run lint && npm run ut\",\"ut\":\"karma start karma.conf.js\",\"utd\":\"karma start --single-run false --browsers Chrome karma.conf.js \",\"build\":\"npm run build:prod\",\"build:dev\":\"webpack --mode development\",\"build:prod\":\"webpack --mode production\",\"start\":\"webpack-dev-server --config webpack.config.dev.js --mode development --open\",\"lint\":\"eslint ./src\",\"lint-errors\":\"eslint --quiet ./src\",\"docs\":\"rm -rf yaml && mkdir yaml && jsdoc -c jsdoc.conf.json\"}}");
...
/***/ "./src/converter/dataConverterStore.js":
/*!*********************************************!*\
  !*** ./src/converter/dataConverterStore.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _model_dataConverter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model/dataConverter */ "./src/converter/model/dataConverter.js");
/* harmony import */ var _defaultConverters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./defaultConverters */ "./src/converter/defaultConverters/index.js");
...
var DataConverterStore = function () {
    function DataConverterStore() {
        _classCallCheck(this, DataConverterStore);

        this.store = new Map();
        this.converters(this._getDefaultConverters());
    }

    _createClass(DataConverterStore, [{
        key: '_getDefaultConverters',
        value: function _getDefaultConverters() {
            return [new _defaultConverters__WEBPACK_IMPORTED_MODULE_1__["DSVStringConverter"](), new _defaultConverters__WEBPACK_IMPORTED_MODULE_1__["DSVArrayConverter"](), new _defaultConverters__WEBPACK_IMPORTED_MODULE_1__["JSONConverter"](), new _defaultConverters__WEBPACK_IMPORTED_MODULE_1__["AutoDataConverter"]()];
        }
        ...
        value: function converters() {
            ...
            var _converters = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

            _converters.forEach(function (converter) {
                return _this.store.set(converter.type, converter);
            });
            return this.store;
        }
        ...
        key: 'register',
        value: function register(converter) {
            if (converter instanceof _model_dataConverter__WEBPACK_IMPORTED_MODULE_0__["default"]) {
        ...
        key: 'unregister',
        value: function unregister(converter) {
    ...
    return DataConverterStore;
}();

var converterStore = function () {
    var store = null;
...
/* harmony default export */ __webpack_exports__["default"] = (converterStore);

/***/ }),

/***/ "./src/converter/defaultConverters/autoConverter.js":
/*!**********************************************************!*\
  !*** ./src/converter/defaultConverters/autoConverter.js ***!
  \**********************************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _model_dataConverter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/dataConverter */ "./src/converter/model/dataConverter.js");
/* harmony import */ var _utils_auto_resolver__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/auto-resolver */ "./src/converter/utils/auto-resolver.js");
/* harmony import */ var _enums_data_format__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../enums/data-format */ "./src/enums/data-format.js");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var AutoDataConverter = function (_DataConverter) {
    _inherits(AutoDataConverter, _DataConverter);

    function AutoDataConverter() {
        _classCallCheck(this, AutoDataConverter);

        return _possibleConstructorReturn(this, (AutoDataConverter.__proto__ || Object.getPrototypeOf(AutoDataConverter)).call(this, _enums_data_format__WEBPACK_IMPORTED_MODULE_2__["default"].AUTO));
    }

    _createClass(AutoDataConverter, [{
        key: 'convert',
        value: function convert(data, schema, options) {
            return Object(_utils_auto_resolver__WEBPACK_IMPORTED_MODULE_1__["default"])(data, schema, options);
        }
    }]);

    return AutoDataConverter;
}(_model_dataConverter__WEBPACK_IMPORTED_MODULE_0__["default"]);

/* harmony default export */ __webpack_exports__["default"] = (AutoDataConverter);

/***/ }),

/***/ "./src/converter/defaultConverters/dsvArrayConverter.js":
/*!**************************************************************!*\
  !*** ./src/converter/defaultConverters/dsvArrayConverter.js ***!
  \**************************************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _model_dataConverter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/dataConverter */ "./src/converter/model/dataConverter.js");
/* harmony import */ var _utils_dsv_arr__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/dsv-arr */ "./src/converter/utils/dsv-arr.js");
/* harmony import */ var _enums_data_format__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../enums/data-format */ "./src/enums/data-format.js");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var DSVArrayConverter = function (_DataConverter) {
    _inherits(DSVArrayConverter, _DataConverter);

    function DSVArrayConverter() {
        _classCallCheck(this, DSVArrayConverter);

        return _possibleConstructorReturn(this, (DSVArrayConverter.__proto__ || Object.getPrototypeOf(DSVArrayConverter)).call(this, _enums_data_format__WEBPACK_IMPORTED_MODULE_2__["default"].DSV_ARR));
    }

    _createClass(DSVArrayConverter, [{
        key: 'convert',
        value: function convert(data, schema, options) {
            return Object(_utils_dsv_arr__WEBPACK_IMPORTED_MODULE_1__["default"])(data, schema, options);
        }
    }]);

    return DSVArrayConverter;
}(_model_dataConverter__WEBPACK_IMPORTED_MODULE_0__["default"]);

/* harmony default export */ __webpack_exports__["default"] = (DSVArrayConverter);

/***/ }),

/***/ "./src/converter/defaultConverters/dsvStringConverter.js":
/*!***************************************************************!*\
  !*** ./src/converter/defaultConverters/dsvStringConverter.js ***!
  \***************************************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _model_dataConverter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/dataConverter */ "./src/converter/model/dataConverter.js");
/* harmony import */ var _utils_dsv_str__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/dsv-str */ "./src/converter/utils/dsv-str.js");
/* harmony import */ var _enums_data_format__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../enums/data-format */ "./src/enums/data-format.js");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var DSVStringConverter = function (_DataConverter) {
    _inherits(DSVStringConverter, _DataConverter);

    function DSVStringConverter() {
        _classCallCheck(this, DSVStringConverter);

        return _possibleConstructorReturn(this, (DSVStringConverter.__proto__ || Object.getPrototypeOf(DSVStringConverter)).call(this, _enums_data_format__WEBPACK_IMPORTED_MODULE_2__["default"].DSV_STR));
    }

    _createClass(DSVStringConverter, [{
        key: 'convert',
        value: function convert(data, schema, options) {
            return Object(_utils_dsv_str__WEBPACK_IMPORTED_MODULE_1__["default"])(data, schema, options);
        }
    }]);

    return DSVStringConverter;
}(_model_dataConverter__WEBPACK_IMPORTED_MODULE_0__["default"]);

/* harmony default export */ __webpack_exports__["default"] = (DSVStringConverter);

/***/ }),

/***/ "./src/converter/defaultConverters/index.js":
/*!**************************************************!*\
  !*** ./src/converter/defaultConverters/index.js ***!
  \**************************************************/
/*! exports provided: DSVStringConverter, JSONConverter, DSVArrayConverter, AutoDataConverter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dsvStringConverter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dsvStringConverter */ "./src/converter/defaultConverters/dsvStringConverter.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DSVStringConverter", function() { return _dsvStringConverter__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var _jsonConverter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./jsonConverter */ "./src/converter/defaultConverters/jsonConverter.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "JSONConverter", function() { return _jsonConverter__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _dsvArrayConverter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dsvArrayConverter */ "./src/converter/defaultConverters/dsvArrayConverter.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DSVArrayConverter", function() { return _dsvArrayConverter__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _autoConverter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./autoConverter */ "./src/converter/defaultConverters/autoConverter.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AutoDataConverter", function() { return _autoConverter__WEBPACK_IMPORTED_MODULE_3__["default"]; });
...
/***/ "./src/converter/defaultConverters/jsonConverter.js":
/*!**********************************************************!*\
  !*** ./src/converter/defaultConverters/jsonConverter.js ***!
  \**********************************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _model_dataConverter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/dataConverter */ "./src/converter/model/dataConverter.js");
/* harmony import */ var _utils_flat_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/flat-json */ "./src/converter/utils/flat-json.js");
/* harmony import */ var _enums_data_format__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../enums/data-format */ "./src/enums/data-format.js");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var JSONConverter = function (_DataConverter) {
    _inherits(JSONConverter, _DataConverter);

    function JSONConverter() {
        _classCallCheck(this, JSONConverter);

        return _possibleConstructorReturn(this, (JSONConverter.__proto__ || Object.getPrototypeOf(JSONConverter)).call(this, _enums_data_format__WEBPACK_IMPORTED_MODULE_2__["default"].FLAT_JSON));
    }

    _createClass(JSONConverter, [{
        key: 'convert',
        value: function convert(data, schema, options) {
            return Object(_utils_flat_json__WEBPACK_IMPORTED_MODULE_1__["default"])(data, schema, options);
        }
    }]);
...
/* harmony default export */ __webpack_exports__["default"] = (JSONConverter);
...
/*!********************************!*\
  !*** ./src/converter/index.js ***!
  \********************************/
/*! exports provided: DataConverter, converterStore */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dataConverterStore__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dataConverterStore */ "./src/converter/dataConverterStore.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "converterStore", function() { return _dataConverterStore__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var _model_dataConverter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./model/dataConverter */ "./src/converter/model/dataConverter.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DataConverter", function() { return _model_dataConverter__WEBPACK_IMPORTED_MODULE_1__["default"]; });
...
/***/ "./src/converter/model/dataConverter.js":
/*!**********************************************!*\
  !*** ./src/converter/model/dataConverter.js ***!
  \**********************************************/
/*! exports provided: default */
...
/***/ "./src/converter/utils/auto-resolver.js":
/*!**********************************************!*\
  !*** ./src/converter/utils/auto-resolver.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _flat_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./flat-json */ "./src/converter/utils/flat-json.js");
/* harmony import */ var _dsv_arr__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dsv-arr */ "./src/converter/utils/dsv-arr.js");
/* harmony import */ var _dsv_str__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dsv-str */ "./src/converter/utils/dsv-str.js");
...
/***/ "./src/converter/utils/dsv-arr.js":
/*!****************************************!*\
  !*** ./src/converter/utils/dsv-arr.js ***!
  \****************************************/
/*! exports provided: default */
...
function DSVArr(arr, schema, options) {
    ...
    var headerMap = headers.reduce(function (acc, h, i) {
        return Object.assign(acc, _defineProperty({}, h, i));
    }, {});

    arr.forEach(function (fields) {
        var field = [];
        schemaFields.forEach(function (schemaField) {
            var headIndex = headerMap[schemaField];
            field.push(fields[headIndex]);
        });
        return push.apply(undefined, field);
    });
...
/***/ "./src/converter/utils/dsv-str.js":
/*!****************************************!*\
  !*** ./src/converter/utils/dsv-str.js ***!
  \****************************************/
/*! exports provided: default */
...
/***/ "./src/converter/utils/flat-json.js":
/*!******************************************!*\
  !*** ./src/converter/utils/flat-json.js ***!
  \******************************************/
/*! exports provided: default */
...
function FlatJSON(arr, schema) {
    ...
    arr.forEach(function (item) {
        var fields = [];
        schemaFieldsName.forEach(function (unitSchema) {
...
/* harmony import */ var _converter__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./converter */ "./src/converter/index.js");
/* harmony import */ var _fields__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./fields */ "./src/fields/index.js");
    ...
    _createClass(DataModel, [{
        ...
        */
        ...
        value: function propagate(identifiers) {
            ...
            Object(_helper__WEBPACK_IMPORTED_MODULE_1__["propagateToAllDataModels"])(identifiers, rootModels, { propagationNameSpace: propagationNameSpace,
                sourceId: propagationSourceId,
                propagationSource: this }, Object.assign({
                payload: payload
            }, config));

            if (isMutableAction) {
                Object(_helper__WEBPACK_IMPORTED_MODULE_1__["propagateImmutableActions"])(propagationNameSpace, rootModel, {
                    config: config,
        ...
        key: 'Converters',
        get: function get() {
            return _converter__WEBPACK_IMPORTED_MODULE_10__["converterStore"];
        }
        ...
        key: 'FieldTypes',
        get: function get() {
            return _fields__WEBPACK_IMPORTED_MODULE_11__["fieldRegistry"];
        }
    }]);
...
/* harmony import */ var _converter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./converter */ "./src/converter/index.js");
...
/* harmony import */ var _fields__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./fields */ "./src/fields/index.js");
...
var Operators = {
    ...
    rowDiffsetIterator: _operator__WEBPACK_IMPORTED_MODULE_1__["rowDiffsetIterator"]
};
...
Object.assign(_datamodel__WEBPACK_IMPORTED_MODULE_0__["default"], {
    ...
    version: version,
    DataConverter: _converter__WEBPACK_IMPORTED_MODULE_4__["DataConverter"],
    FieldsUtility: _fields__WEBPACK_IMPORTED_MODULE_9__
...
function createUnitField(data, schema) {
    ...
    if (_fields__WEBPACK_IMPORTED_MODULE_1__["fieldRegistry"].has(schema.subtype)) {
        return _fields__WEBPACK_IMPORTED_MODULE_1__["fieldRegistry"].get(schema.subtype).BUILDER.fieldName(schema.name).schema(schema).data(data).rowDiffset('0-' + (data.length - 1)).build();
    }
    return _fields__WEBPACK_IMPORTED_MODULE_1__["fieldRegistry"].get(schema.type === _enums__WEBPACK_IMPORTED_MODULE_0__["FieldType"].MEASURE ? _enums__WEBPACK_IMPORTED_MODULE_0__["MeasureSubtype"].CONTINUOUS : _enums__WEBPACK_IMPORTED_MODULE_0__["DimensionSubtype"].CATEGORICAL).BUILDER.fieldName(schema.name).schema(schema).data(data).rowDiffset('0-' + (data.length - 1)).build();
}
...
function createUnitFieldFromPartial(partialField, rowDiffset) {
    ...
    if (_fields__WEBPACK_IMPORTED_MODULE_1__["fieldRegistry"].has(schema.subtype)) {
        return _fields__WEBPACK_IMPORTED_MODULE_1__["fieldRegistry"].get(schema.subtype).BUILDER.partialField(partialField).rowDiffset(rowDiffset).build();
    }
    return _fields__WEBPACK_IMPORTED_MODULE_1__["fieldRegistry"].get(schema.type === _enums__WEBPACK_IMPORTED_MODULE_0__["FieldType"].MEASURE ? _enums__WEBPACK_IMPORTED_MODULE_0__["MeasureSubtype"].CONTINUOUS : _enums__WEBPACK_IMPORTED_MODULE_0__["DimensionSubtype"].CATEGORICAL).BUILDER.partialField(partialField).rowDiffset(rowDiffset).build();
}
...
/* harmony import */ var _parsers_binned_parser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../parsers/binned-parser */ "./src/fields/parsers/binned-parser/index.js");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Binned = function (_Dimension) {
    ...
    _createClass(Binned, [{
        ...
        value: function parser() {
            return new _parsers_binned_parser__WEBPACK_IMPORTED_MODULE_1__["default"]();
        }
    }]);
...
/* harmony import */ var _parsers_categorical_parser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../parsers/categorical-parser */ "./src/fields/parsers/categorical-parser/index.js");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Categorical = function (_Dimension) {
    ...
    _createClass(Categorical, [{
        ...
        key: 'parser',
        value: function parser() {
            return new _parsers_categorical_parser__WEBPACK_IMPORTED_MODULE_3__["default"]();
        }
    }]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _enums__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../enums */ "./src/enums/index.js");
/* harmony import */ var _measure__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../measure */ "./src/fields/measure/index.js");
/* harmony import */ var _parsers_continuous_parser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../parsers/continuous-parser */ "./src/fields/parsers/continuous-parser/index.js");
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helper */ "./src/fields/helper.js");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Continuous = function (_Measure) {
    ...
    _createClass(Continuous, [{
         ...
         */
        value: function subtype() {
            return _enums__WEBPACK_IMPORTED_MODULE_0__["MeasureSubtype"].CONTINUOUS;
        }
        ...
        key: 'calculateDataDomain',
        value: function calculateDataDomain() {
            return Object(_helper__WEBPACK_IMPORTED_MODULE_3__["calculateContinuousDomain"])(this.partialField.data, this.rowDiffset);
        }
    }], [{
        key: 'parser',
        value: function parser() {
            return new _parsers_continuous_parser__WEBPACK_IMPORTED_MODULE_2__["default"]();
        }
    }]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _categorical__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./categorical */ "./src/fields/categorical/index.js");
/* harmony import */ var _temporal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./temporal */ "./src/fields/temporal/index.js");
/* harmony import */ var _binned__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./binned */ "./src/fields/binned/index.js");
/* harmony import */ var _continuous__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./continuous */ "./src/fields/continuous/index.js");
...
var FieldTypeRegistry = function () {
    function FieldTypeRegistry() {
        _classCallCheck(this, FieldTypeRegistry);

        this._fieldType = new Map();
    }

    _createClass(FieldTypeRegistry, [{
        key: 'registerFieldType',
        value: function registerFieldType(subtype, dimension) {
...
var registerDefaultFields = function registerDefaultFields(store) {
...
/* harmony default export */ __webpack_exports__["default"] = (fieldRegistry);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _operator_row_diffset_iterator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../operator/row-diffset-iterator */ "./src/operator/row-diffset-iterator.js");
/* harmony import */ var _partial_field__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../partial-field */ "./src/fields/partial-field/index.js");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
        ...
        get: function get() {
            var builder = {
                ...
                schema: function schema(_schema) {
                    this._params.schema = _schema;
                    return this;
                },
                data: function data(_data) {
                    this._params.data = _data;
                    return this;
                },
                partialField: function partialField(_partialField) {
                    this._params.partialField = _partialField;
                    return this;
                },
                rowDiffset: function rowDiffset(_rowDiffset) {
                    this._params.rowDiffset = _rowDiffset;
                    return this;
                },
                build: function build() {
                    var partialField = null;
                    if (this._params.partialField instanceof _partial_field__WEBPACK_IMPORTED_MODULE_1__["default"]) {
                        partialField = this._params.partialField;
                    } else if (this._params.schema && this._params.data) {
                        partialField = new _partial_field__WEBPACK_IMPORTED_MODULE_1__["default"](this._params.name, this._params.data, this._params.schema, this._context.parser());
                    } else {
...
/***/ "./src/fields/helper.js":
/*!******************************!*\
  !*** ./src/fields/helper.js ***!
  \******************************/
/*! exports provided: calculateContinuousDomain */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "calculateContinuousDomain", function() { return calculateContinuousDomain; });
/* harmony import */ var _operator_row_diffset_iterator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../operator/row-diffset-iterator */ "./src/operator/row-diffset-iterator.js");
...
var calculateContinuousDomain = function calculateContinuousDomain(data, rowDiffset) {
    var min = Number.POSITIVE_INFINITY;
    var max = Number.NEGATIVE_INFINITY;

    // here don't use this.data() as the iteration will be occurred two times on same data.
    Object(_operator_row_diffset_iterator__WEBPACK_IMPORTED_MODULE_0__["rowDiffsetIterator"])(rowDiffset, function (i) {
        var datum = data[i];
...
/*!*****************************!*\
  !*** ./src/fields/index.js ***!
  \*****************************/
/*! exports provided: Dimension, Measure, FieldParser, fieldRegistry, columnMajor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dimension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dimension */ "./src/fields/dimension/index.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Dimension", function() { return _dimension__WEBPACK_IMPORTED_MODULE_0__["default"]; });
...
/* harmony import */ var _parsers_field_parser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./parsers/field-parser */ "./src/fields/parsers/field-parser/index.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "FieldParser", function() { return _parsers_field_parser__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _field_registry__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./field-registry */ "./src/fields/field-registry.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "fieldRegistry", function() { return _field_registry__WEBPACK_IMPORTED_MODULE_3__["default"]; });

/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils */ "./src/utils/index.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "columnMajor", function() { return _utils__WEBPACK_IMPORTED_MODULE_4__["columnMajor"]; });
...
var TemporalParser = function (_FieldParser) {
    ...
    function TemporalParser() {
        _classCallCheck(this, TemporalParser);

        return _possibleConstructorReturn(this, (TemporalParser.__proto__ || Object.getPrototypeOf(TemporalParser)).apply(this, arguments));
    }
    ...
    _createClass(TemporalParser, [{
         ...
         */
        value: function parse(val, _ref) {
            var format = _ref.format;

            var result = void 0;
            // check if invalid date value
            if (!this._dtf) {
                this._dtf = new _utils__WEBPACK_IMPORTED_MODULE_0__["DateTimeFormatter"](format);
            }
  ...
  _createClass(PartialField, [{
    ...
    value: function _sanitize(data) {
      ...
      return data.map(function (datum) {
        return _this.parser.parse(datum, { format: _this.schema.format });
      });
    }
  }]);
...
/* harmony import */ var _parsers_temporal_parser__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../parsers/temporal-parser */ "./src/fields/parsers/temporal-parser/index.js");
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../helper */ "./src/fields/helper.js");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Temporal = function (_Dimension) {
    ...
    */
    ...
    _createClass(Temporal, [{
        key: 'calculateDataDomain',
        value: function calculateDataDomain() {
            return Object(_helper__WEBPACK_IMPORTED_MODULE_5__["calculateContinuousDomain"])(this.partialField.data, this.rowDiffset);
        }
        ...
        key: 'parser',
        value: function parser() {
            return new _parsers_temporal_parser__WEBPACK_IMPORTED_MODULE_4__["default"]();
        }
    }]);
...
/*!***********************!*\
  !*** ./src/helper.js ***!
  \***********************/
/*! exports provided: prepareJoinData, updateFields, persistCurrentDerivation, persistAncestorDerivation, persistDerivations, selectRowDiffsetIterator, rowSplitDiffsetIterator, selectHelper, cloneWithAllFields, filterPropagationModel, splitWithSelect, addDiffsetToClonedDm, cloneWithSelect, cloneWithProject, splitWithProject, sanitizeUnitSchema, validateUnitSchema, sanitizeAndValidateSchema, resolveFieldName, updateData, fieldInSchema, getDerivationArguments, getRootGroupByModel, getRootDataModel, getPathToRootModel, propagateToAllDataModels, propagateImmutableActions, addToPropNamespace, getNormalizedProFields, getNumberFormattedVal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _fields__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./fields */ "./src/fields/index.js");
...
var selectHelper = function selectHelper(clonedDm, selectFn, config, sourceDm, iterator) {
    ...
    var cachedValueObjects = clonedDm._partialFieldspace._cachedValueObjects;
...
var keyFn = function keyFn(arr, fields, idx, rowId) {
    var field = arr[idx];
    var val = field === _constants__WEBPACK_IMPORTED_MODULE_4__["ROW_ID"] ? rowId : fields[field].internalValue;
    return val;
};

var domainChecker = function domainChecker(val, domain) {
    var domainArr = domain[0] instanceof Array ? domain : [domain];
    return domainArr.some(function (dom) {
        return val >= dom[0] && val <= dom[1];
    });
};

var boundsChecker = (_boundsChecker = {}, _defineProperty(_boundsChecker, _enums__WEBPACK_IMPORTED_MODULE_0__["MeasureSubtype"].CONTINUOUS, domainChecker), _defineProperty(_boundsChecker, _enums__WEBPACK_IMPORTED_MODULE_0__["DimensionSubtype"].TEMPORAL, domainChecker), _boundsChecker);

var isWithinDomain = function isWithinDomain(value, domain, fieldType) {
    return boundsChecker[fieldType](value, domain);
};
...
var filterPropagationModel = function filterPropagationModel(model, propModels) {
    ...
    var _config$filterByDim = config.filterByDim,
        filterByDim = _config$filterByDim === undefined ? true : _config$filterByDim,
        _config$filterByMeasu = config.filterByMeasure,
        filterByMeasure = _config$filterByMeasu === undefined ? false : _config$filterByMeasu,
        _config$clone = config.clone,
        clone = _config$clone === undefined ? true : _config$clone;

    var clonedModel = clone ? cloneWithAllFields(model) : model;
    ...
    if (!propModels.length) {
        ...
        fns = propModels.map(function (propModel) {
            return function (_ref5) {
                var _ref5$criteria = _ref5.criteria,
                    criteria = _ref5$criteria === undefined ? {} : _ref5$criteria;
                var _criteria$identifiers = criteria.identifiers,
                    identifiers = _criteria$identifiers === undefined ? [[], []] : _criteria$identifiers,
                    range = criteria.range;

                var _identifiers = _slicedToArray(identifiers, 2),
                    _identifiers$ = _identifiers[0],
                    fieldNames = _identifiers$ === undefined ? [] : _identifiers$,
                    _identifiers$2 = _identifiers[1],
                    values = _identifiers$2 === undefined ? [] : _identifiers$2;

                var indices = fieldNames.reduce(function (map, name, i) {
                    map[name] = i;
                    return map;
                }, {});
                fieldNames = fieldNames.filter(function (field) {
                    return field in modelFieldsConfig && modelFieldsConfig[field].def.type === _enums__WEBPACK_IMPORTED_MODULE_0__["FieldType"].DIMENSION || field === _constants__WEBPACK_IMPORTED_MODULE_4__["ROW_ID"];
                });
                var dLen = fieldNames.length;
                var valuesMap = {};

                if (dLen) {
                    var _loop = function _loop(i, len) {
                        var row = identifiers[i];
                        var key = '' + fieldNames.map(function (field) {
                ...
                var rangeKeys = Object.keys(range || {}).filter(function (field) {
                    return field in modelFieldsConfig;
                });
                var hasData = values.length || rangeKeys.length;

                if (!filterByMeasure) {
                    rangeKeys = rangeKeys.filter(function (field) {
                        return modelFieldsConfig[field].def.type !== _enums__WEBPACK_IMPORTED_MODULE_0__["FieldType"].MEASURE;
                    });
                }

                if (!filterByDim) {
                    rangeKeys = rangeKeys.filter(function (field) {
                        return modelFieldsConfig[field].def.type !== _enums__WEBPACK_IMPORTED_MODULE_0__["FieldType"].DIMENSION;
                    });
                }

                return hasData ? function (fields, i) {
                    var present = true;
                    if (filterByDim) {
                        present = dLen ? valuesMap[getKey(fieldNames, fields, keyFn, i)] : true;
                    }

                    return rangeKeys.every(function (field) {
                        var val = fields[field].internalValue;
...
var sanitizeUnitSchema = function sanitizeUnitSchema(unitSchema) {
    ...
    unitSchema = Object(_utils__WEBPACK_IMPORTED_MODULE_9__["extend2"])({}, unitSchema);
    if (!unitSchema.type) {
...
var validateUnitSchema = function validateUnitSchema(unitSchema) {
    ...
    if (type === _enums__WEBPACK_IMPORTED_MODULE_0__["FieldType"].DIMENSION || type === _enums__WEBPACK_IMPORTED_MODULE_0__["FieldType"].MEASURE) {
        if (!_fields__WEBPACK_IMPORTED_MODULE_8__["fieldRegistry"].has(subtype)) {
...
var updateData = function updateData(relation, data, schema, options) {
    ...
    var converter = _converter__WEBPACK_IMPORTED_MODULE_7__["converterStore"].get(options.dataFormat);

    if (!converter) {
        throw new Error('No converter function found for ' + options.dataFormat + ' format');
    }

    var _converter$convert = converter.convert(data, schema, options),
        _converter$convert2 = _slicedToArray(_converter$convert, 2),
        header = _converter$convert2[0],
        formattedData = _converter$convert2[1];
    ...
    relation._dataFormat = options.dataFormat === _enums__WEBPACK_IMPORTED_MODULE_0__["DataFormat"].AUTO ? Object(_utils__WEBPACK_IMPORTED_MODULE_9__["detectDataFormat"])(data) : options.dataFormat;
    return relation;
};
...
var propagateIdentifiers = function propagateIdentifiers(dataModel, propModel) {
    ...
    var criterias = propModelInf.criteria;
    ...
    children.forEach(function (child) {
        var matchingCriteria = criterias.filter(function (val) {
            return val.groupedModel === child;
        });
...
var propagateToAllDataModels = function propagateToAllDataModels(identifiers, rootModels, propagationInf, config) {
    ...
    var addGroupedModel = function addGroupedModel(_ref6) {
        var conf = _ref6.config,
            model = _ref6.model;
        var crit = conf.criteria;

        var groupedModel = void 0;

        if (crit !== null && crit.fields.some(function (d) {
            return d.type === _enums__WEBPACK_IMPORTED_MODULE_0__["FieldType"].MEASURE;
        })) {
    ...
    if (identifiers === null) {
        ...
        var filteredCriteria = actionCriterias.filter(filterFn);
        ...
        criteria = (_ref7 = []).concat.apply(_ref7, [].concat(_toConsumableArray(filteredCriteria.map(addGroupedModel)), [{
            criteria: identifiers,
            groupedModel: identifiers !== null && identifiers.fields.some(function (d) {
                return d.type === _enums__WEBPACK_IMPORTED_MODULE_0__["FieldType"].MEASURE;
    ...
    criterias.forEach(function (inf) {
        var crit = inf.criteria;

        var propagationModel = filterPropagationModel(rootModel, crit, {
            filterByMeasure: !!crit.find(function (d) {
                return d.groupedModel === rootModel;
            })
        });
        var path = inf.path;
...
var propagateImmutableActions = function propagateImmutableActions(propagationNameSpace, rootModel, propagationInf) {
...
function dataBuilder(fieldStore, rowDiffset, colIdentifier, sortingDetails, options) {
    ...
    if (addUid) {
        retObj.schema.push({
            name: _constants__WEBPACK_IMPORTED_MODULE_3__["ROW_ID"],
            type: _enums__WEBPACK_IMPORTED_MODULE_2__["FieldType"].DIMENSION
        });
    }
